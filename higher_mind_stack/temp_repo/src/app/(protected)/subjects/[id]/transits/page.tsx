...
import { TransitChartView } from '../../../_components/TransitChartView'
...
export default async function Page({ params }: PageProps) {
  ...
  if (!session || !canAccessChartType(session.subscriptionPlan, 'transits')) {
    redirect('/pricing')
  }

  const { id } = await params
  return <TransitChartView subjectId={id} />
}
