...
import { CompositeSelectionView } from '../../../_components/CompositeSelectionView'
...
export default async function Page({ params }: PageProps) {
  ...
  if (!session || !canAccessChartType(session.subscriptionPlan, 'composite')) {
    redirect('/pricing')
  }

  const { id } = await params
  return <CompositeSelectionView subjectId={id} />
}
