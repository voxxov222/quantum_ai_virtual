...
import { LunarReturnView } from '../../../_components/LunarReturnView'
...
export default async function Page({ params }: PageProps) {
  ...
  if (!session || !canAccessChartType(session.subscriptionPlan, 'lunar-return')) {
    redirect('/pricing')
  }

  const { id } = await params
  return <LunarReturnView subjectId={id} />
}
